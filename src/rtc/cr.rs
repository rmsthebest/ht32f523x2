...
impl W {
    ...
    #[doc = "Bit 2 - LSIEN"]
    #[inline]
    pub fn lsien(&mut self) -> _LSIENW {
        _LSIENW { w: self }
    }
    #[doc = "Bit 3 - LSEEN"]
    #[inline]
    pub fn lseen(&mut self) -> _LSEENW {
        _LSEENW { w: self }
    }
    #[doc = "Bit 4 - CMPCLR"]
    #[inline]
    pub fn cmpclr(&mut self) -> _CMPCLRW {
        _CMPCLRW { w: self }
    }
    #[doc = "Bit 5 - LSESM"]
    #[inline]
    pub fn lsesm(&mut self) -> _LSESMW {
        _LSESMW { w: self }
    }
    #[doc = "Bits 8:11 - RPRE"]
    #[inline]
    pub fn rpre(&mut self) -> _RPREW {
        _RPREW { w: self }
    }
    #[doc = "Bit 16 - ROEN"]
    #[inline]
    ...
    #[doc = "Bit 19 - ROAP"]
    #[inline]
    pub fn roap(&mut self) -> _ROAPW {
        _ROAPW { w: self }
    }
    #[doc = "Bit 20 - ROLF"]
    #[inline]
    pub fn rolf(&mut self) -> _ROLFW {
        _ROLFW { w: self }
    }
}
