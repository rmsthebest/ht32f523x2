...
impl W {
    ...
    #[doc = "Bit 0 - I2C0EN"]
    #[inline]
    pub fn i2c0en(&mut self) -> _I2C0ENW {
        _I2C0ENW { w: self }
    }
    #[doc = "Bit 1 - I2C1EN"]
    #[inline]
    ...
    #[doc = "Bit 4 - SPI0EN"]
    #[inline]
    pub fn spi0en(&mut self) -> _SPI0ENW {
        _SPI0ENW { w: self }
    }
    #[doc = "Bit 5 - SPI1EN"]
    #[inline]
    ...
    #[doc = "Bit 8 - USR0EN"]
    #[inline]
    pub fn usr0en(&mut self) -> _USR0ENW {
        _USR0ENW { w: self }
    }
    #[doc = "Bit 9 - USR1EN"]
    #[inline]
    pub fn usr1en(&mut self) -> _USR1ENW {
        _USR1ENW { w: self }
    }
    #[doc = "Bit 10 - UR0EN"]
    #[inline]
    pub fn ur0en(&mut self) -> _UR0ENW {
        _UR0ENW { w: self }
    }
    #[doc = "Bit 11 - UR1EN"]
    #[inline]
    pub fn ur1en(&mut self) -> _UR1ENW {
        _UR1ENW { w: self }
    }
    #[doc = "Bit 14 - AFIOEN"]
    #[inline]
    ...
    #[doc = "Bit 15 - EXTIEN"]
    #[inline]
    pub fn extien(&mut self) -> _EXTIENW {
        _EXTIENW { w: self }
    }
    #[doc = "Bit 24 - SCI0EN"]
    #[inline]
    pub fn sci0en(&mut self) -> _SCI0ENW {
        _SCI0ENW { w: self }
    }
    #[doc = "Bit 25 - I2SEN"]
    #[inline]
    ...
    #[doc = "Bit 27 - SCI1EN"]
    #[inline]
    pub fn sci1en(&mut self) -> _SCI1ENW {
        _SCI1ENW { w: self }
    }
}
