...
impl W {
    ...
    #[doc = "Bit 0 - CKSF"]
    #[inline]
    pub fn cksf(&mut self) -> _CKSFW {
        _CKSFW { w: self }
    }
    #[doc = "Bit 2 - PLLRDYF"]
    #[inline]
    pub fn pllrdyf(&mut self) -> _PLLRDYFW {
        _PLLRDYFW { w: self }
    }
    #[doc = "Bit 3 - HSERDYF"]
    #[inline]
    pub fn hserdyf(&mut self) -> _HSERDYFW {
        _HSERDYFW { w: self }
    }
    #[doc = "Bit 4 - HSIRDYF"]
    #[inline]
    pub fn hsirdyf(&mut self) -> _HSIRDYFW {
        _HSIRDYFW { w: self }
    }
    #[doc = "Bit 5 - LSERDYF"]
    #[inline]
    pub fn lserdyf(&mut self) -> _LSERDYFW {
        _LSERDYFW { w: self }
    }
    #[doc = "Bit 6 - LSIRDYF"]
    #[inline]
    pub fn lsirdyf(&mut self) -> _LSIRDYFW {
        _LSIRDYFW { w: self }
    }
    #[doc = "Bit 16 - CKSIE"]
    #[inline]
    pub fn cksie(&mut self) -> _CKSIEW {
        _CKSIEW { w: self }
    }
    #[doc = "Bit 18 - PLLRDYIE"]
    #[inline]
