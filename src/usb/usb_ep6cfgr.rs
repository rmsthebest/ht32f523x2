...
impl W {
    ...
    #[doc = "Bits 0:9 - EPBUFA"]
    #[inline]
    pub fn epbufa(&mut self) -> _EPBUFAW {
        _EPBUFAW { w: self }
    }
    #[doc = "Bits 10:19 - EPLEN"]
    #[inline]
    pub fn eplen(&mut self) -> _EPLENW {
        _EPLENW { w: self }
    }
    #[doc = "Bit 23 - SDBS"]
    #[inline]
    pub fn sdbs(&mut self) -> _SDBSW {
        _SDBSW { w: self }
    }
    #[doc = "Bits 24:27 - EPADR"]
    #[inline]
