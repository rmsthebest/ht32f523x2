#[doc = "Reader of register EP0CFGR"]
pub type R = crate::R<u32, super::EP0CFGR>;
#[doc = "Writer for register EP0CFGR"]
pub type W = crate::W<u32, super::EP0CFGR>;
#[doc = "Register EP0CFGR `reset()`'s with value 0"]
impl crate::ResetValue for super::EP0CFGR {
    type Type = u32;
    #[inline(always)]
