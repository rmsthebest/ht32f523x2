...
pub type R = crate::R<Ep1csrSpec>;
#[doc = "Register `EP1CSR` writer"]
pub type W = crate::W<Ep1csrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtgtx(&mut self) -> DtgtxW<Ep1csrSpec> {
        DtgtxW::new(self, 0)
    }
    #[doc = "Bit 1 - NAKTX"]
    #[inline(always)]
    #[must_use]
    pub fn naktx(&mut self) -> NaktxW<Ep1csrSpec> {
        NaktxW::new(self, 1)
    }
    #[doc = "Bit 2 - STLTX"]
    #[inline(always)]
    #[must_use]
    pub fn stltx(&mut self) -> StltxW<Ep1csrSpec> {
        StltxW::new(self, 2)
    }
    #[doc = "Bit 3 - DTGRX"]
    #[inline(always)]
    #[must_use]
    pub fn dtgrx(&mut self) -> DtgrxW<Ep1csrSpec> {
        DtgrxW::new(self, 3)
    }
    #[doc = "Bit 4 - NAKRX"]
    #[inline(always)]
    #[must_use]
    pub fn nakrx(&mut self) -> NakrxW<Ep1csrSpec> {
        NakrxW::new(self, 4)
    }
    #[doc = "Bit 5 - STLRX"]
    #[inline(always)]
    #[must_use]
    pub fn stlrx(&mut self) -> StlrxW<Ep1csrSpec> {
        StlrxW::new(self, 5)
    }
}
#[doc = "EP1CSR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ep1csr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ep1csr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ep1csrSpec;
impl crate::RegisterSpec for Ep1csrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ep1csr::R`](R) reader structure"]
impl crate::Readable for Ep1csrSpec {}
#[doc = "`write(|w| ..)` method takes [`ep1csr::W`](W) writer structure"]
impl crate::Writable for Ep1csrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EP1CSR to value 0"]
impl crate::Resettable for Ep1csrSpec {
