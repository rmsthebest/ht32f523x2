...
pub struct R(crate::R<EP2CSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EP2CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EP2CSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EP2CSR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EP2CSR` writer"]
pub struct W(crate::W<EP2CSR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EP2CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EP2CSR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EP2CSR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "EP2CSR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ep2csr](index.html) module"]
pub struct EP2CSR_SPEC;
impl crate::RegisterSpec for EP2CSR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ep2csr::R](R) reader structure"]
impl crate::Readable for EP2CSR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ep2csr::W](W) writer structure"]
impl crate::Writable for EP2CSR_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets EP2CSR to value 0"]
impl crate::Resettable for EP2CSR_SPEC {
