...
pub type R = crate::R<Ep7tcrSpec>;
#[doc = "Register `EP7TCR` writer"]
pub type W = crate::W<Ep7tcrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcnt0(&mut self) -> Tcnt0W<Ep7tcrSpec> {
        Tcnt0W::new(self, 0)
    }
    #[doc = "Bits 16:25 - TCNT1"]
    #[inline(always)]
    #[must_use]
    pub fn tcnt1(&mut self) -> Tcnt1W<Ep7tcrSpec> {
        Tcnt1W::new(self, 16)
    }
}
#[doc = "EP7TCR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ep7tcr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ep7tcr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ep7tcrSpec;
impl crate::RegisterSpec for Ep7tcrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ep7tcr::R`](R) reader structure"]
impl crate::Readable for Ep7tcrSpec {}
#[doc = "`write(|w| ..)` method takes [`ep7tcr::W`](W) writer structure"]
impl crate::Writable for Ep7tcrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EP7TCR to value 0"]
impl crate::Resettable for Ep7tcrSpec {
