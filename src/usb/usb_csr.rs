...
impl W {
    ...
    #[doc = "Bit 5 - GENRSM"]
    #[inline]
    pub fn genrsm(&mut self) -> _GENRSMW {
        _GENRSMW { w: self }
    }
    #[doc = "Bit 6 - RXDP"]
    #[inline]
    pub fn rxdp(&mut self) -> _RXDPW {
        _RXDPW { w: self }
    }
    #[doc = "Bit 7 - RXDM"]
    #[inline]
    pub fn rxdm(&mut self) -> _RXDMW {
        _RXDMW { w: self }
    }
    #[doc = "Bit 8 - ADRSET"]
    #[inline]
    pub fn adrset(&mut self) -> _ADRSETW {
        _ADRSETW { w: self }
    }
    #[doc = "Bit 9 - SRAMRSTC"]
    #[inline]
    pub fn sramrstc(&mut self) -> _SRAMRSTCW {
        _SRAMRSTCW { w: self }
    }
    #[doc = "Bit 10 - DPPUEN"]
    #[inline]
    pub fn dppuen(&mut self) -> _DPPUENW {
        _DPPUENW { w: self }
    }
    #[doc = "Bit 11 - DPWKEN"]
    #[inline]
    pub fn dpwken(&mut self) -> _DPWKENW {
        _DPWKENW { w: self }
    }
}
