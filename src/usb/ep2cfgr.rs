...
pub type R = crate::R<Ep2cfgrSpec>;
#[doc = "Register `EP2CFGR` writer"]
pub type W = crate::W<Ep2cfgrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn epbufa(&mut self) -> EpbufaW<Ep2cfgrSpec> {
        EpbufaW::new(self, 0)
    }
    #[doc = "Bits 10:16 - EPLEN"]
    #[inline(always)]
    #[must_use]
    pub fn eplen(&mut self) -> EplenW<Ep2cfgrSpec> {
        EplenW::new(self, 10)
    }
    #[doc = "Bits 24:27 - EPADR"]
    #[inline(always)]
    #[must_use]
    pub fn epadr(&mut self) -> EpadrW<Ep2cfgrSpec> {
        EpadrW::new(self, 24)
    }
    #[doc = "Bit 28 - EPDIR"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EpdirW<Ep2cfgrSpec> {
        EpdirW::new(self, 28)
    }
    #[doc = "Bit 29 - EPTYPE"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<Ep2cfgrSpec> {
        EptypeW::new(self, 29)
    }
    #[doc = "Bit 31 - EPEN"]
    #[inline(always)]
    #[must_use]
    pub fn epen(&mut self) -> EpenW<Ep2cfgrSpec> {
        EpenW::new(self, 31)
    }
}
#[doc = "EP2CFGR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ep2cfgr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ep2cfgr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ep2cfgrSpec;
impl crate::RegisterSpec for Ep2cfgrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ep2cfgr::R`](R) reader structure"]
impl crate::Readable for Ep2cfgrSpec {}
#[doc = "`write(|w| ..)` method takes [`ep2cfgr::W`](W) writer structure"]
impl crate::Writable for Ep2cfgrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EP2CFGR to value 0"]
impl crate::Resettable for Ep2cfgrSpec {
