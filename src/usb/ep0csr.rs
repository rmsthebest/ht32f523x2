...
pub type R = crate::R<Ep0csrSpec>;
#[doc = "Register `EP0CSR` writer"]
pub type W = crate::W<Ep0csrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtgtx(&mut self) -> DtgtxW<Ep0csrSpec> {
        DtgtxW::new(self, 0)
    }
    #[doc = "Bit 1 - NAKTX"]
    #[inline(always)]
    #[must_use]
    pub fn naktx(&mut self) -> NaktxW<Ep0csrSpec> {
        NaktxW::new(self, 1)
    }
    #[doc = "Bit 2 - STLTX"]
    #[inline(always)]
    #[must_use]
    pub fn stltx(&mut self) -> StltxW<Ep0csrSpec> {
        StltxW::new(self, 2)
    }
    #[doc = "Bit 3 - DTGRX"]
    #[inline(always)]
    #[must_use]
    pub fn dtgrx(&mut self) -> DtgrxW<Ep0csrSpec> {
        DtgrxW::new(self, 3)
    }
    #[doc = "Bit 4 - NAKRX"]
    #[inline(always)]
    #[must_use]
    pub fn nakrx(&mut self) -> NakrxW<Ep0csrSpec> {
        NakrxW::new(self, 4)
    }
    #[doc = "Bit 5 - STLRX"]
    #[inline(always)]
    #[must_use]
    pub fn stlrx(&mut self) -> StlrxW<Ep0csrSpec> {
        StlrxW::new(self, 5)
    }
}
...
pub struct Ep0csrSpec;
impl crate::RegisterSpec for Ep0csrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ep0csr::R`](R) reader structure"]
impl crate::Readable for Ep0csrSpec {}
#[doc = "`write(|w| ..)` method takes [`ep0csr::W`](W) writer structure"]
impl crate::Writable for Ep0csrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets EP0CSR to value 0"]
impl crate::Resettable for Ep0csrSpec {
