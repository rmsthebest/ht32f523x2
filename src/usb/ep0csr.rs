#[doc = "Register `EP0CSR` reader"]
pub struct R(crate::R<EP0CSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EP0CSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EP0CSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EP0CSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "`read()` method returns [ep0csr::R](R) reader structure"]
impl crate::Readable for EP0CSR_SPEC {
    type Reader = R;
}
