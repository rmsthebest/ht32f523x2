...
impl W {
    ...
    #[doc = "Bit 3 - SELOEN"]
    #[inline]
    pub fn seloen(&mut self) -> _SELOENW {
        _SELOENW { w: self }
    }
    #[doc = "Bit 4 - SSELC"]
    #[inline]
    pub fn sselc(&mut self) -> _SSELCW {
        _SSELCW { w: self }
    }
    #[doc = "Bit 6 - DUALEN"]
    #[inline]
    pub fn dualen(&mut self) -> _DUALENW {
        _DUALENW { w: self }
    }
    #[doc = "Bit 7 - GUADTEN"]
    #[inline]
    pub fn guadten(&mut self) -> _GUADTENW {
        _GUADTENW { w: self }
    }
    #[doc = "Bits 8:11 - GUADT"]
    #[inline]
    pub fn guadt(&mut self) -> _GUADTW {
        _GUADTW { w: self }
    }
    #[doc = "Bits 12:15 - SELHT"]
    #[inline]
    pub fn selht(&mut self) -> _SELHTW {
        _SELHTW { w: self }
    }
}
