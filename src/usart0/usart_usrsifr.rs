...
impl W {
    ...
    #[doc = "Bit 1 - OEI"]
    #[inline]
    pub fn oei(&mut self) -> _OEIW {
        _OEIW { w: self }
    }
    #[doc = "Bit 2 - PEI"]
    #[inline]
    pub fn pei(&mut self) -> _PEIW {
        _PEIW { w: self }
    }
    #[doc = "Bit 3 - FEI"]
    #[inline]
    pub fn fei(&mut self) -> _FEIW {
        _FEIW { w: self }
    }
    #[doc = "Bit 4 - BII"]
    #[inline]
    pub fn bii(&mut self) -> _BIIW {
        _BIIW { w: self }
    }
    #[doc = "Bit 5 - RXDR"]
    #[inline]
    ...
    #[doc = "Bit 9 - RSADDE"]
    #[inline]
    pub fn rsadde(&mut self) -> _RSADDEW {
        _RSADDEW { w: self }
    }
    #[doc = "Bit 10 - CTSC"]
    #[inline]
