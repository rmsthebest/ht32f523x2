...
impl W {
    ...
    #[doc = "Bit 2 - TRSM"]
    #[inline]
    pub fn trsm(&mut self) -> _TRSMW {
        _TRSMW { w: self }
    }
    #[doc = "Bit 3 - HFCEN"]
    #[inline]
    pub fn hfcen(&mut self) -> _HFCENW {
        _HFCENW { w: self }
    }
    #[doc = "Bit 4 - URTXEN"]
    #[inline]
    pub fn urtxen(&mut self) -> _URTXENW {
        _URTXENW { w: self }
    }
    #[doc = "Bit 5 - URRXEN"]
    #[inline]
    pub fn urrxen(&mut self) -> _URRXENW {
        _URRXENW { w: self }
    }
    #[doc = "Bit 6 - TXDMAEN"]
    #[inline]
    ...
    #[doc = "Bit 10 - NSB"]
    #[inline]
    pub fn nsb(&mut self) -> _NSBW {
        _NSBW { w: self }
    }
    #[doc = "Bit 11 - PBE"]
    #[inline]
    pub fn pbe(&mut self) -> _PBEW {
        _PBEW { w: self }
    }
    #[doc = "Bit 12 - EPE"]
    #[inline]
