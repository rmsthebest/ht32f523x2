#[doc = "Reader of register USART_USRCR"]
pub type R = crate::R<u32, super::USART_USRCR>;
#[doc = "Writer for register USART_USRCR"]
pub type W = crate::W<u32, super::USART_USRCR>;
#[doc = "Register USART_USRCR `reset()`'s with value 0"]
impl crate::ResetValue for super::USART_USRCR {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn hfcen(&self) -> HFCEN_R {
        HFCEN_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - URTXEN"]
    #[inline(always)]
