...
impl W {
    ...
    #[doc = "Bits 4:5 - SMPSIZE"]
    #[inline]
    pub fn smpsize(&mut self) -> _SMPSIZEW {
        _SMPSIZEW { w: self }
    }
    #[doc = "Bits 6:7 - FORMAT"]
    #[inline]
    ...
    #[doc = "Bit 8 - BITEXT"]
    #[inline]
    pub fn bitext(&mut self) -> _BITEXTW {
        _BITEXTW { w: self }
    }
    #[doc = "Bit 9 - MCLKEN"]
    #[inline]
    pub fn mclken(&mut self) -> _MCLKENW {
        _MCLKENW { w: self }
    }
    #[doc = "Bit 10 - REPEAT"]
    #[inline]
    ...
    #[doc = "Bit 12 - TXMUTE"]
    #[inline]
    pub fn txmute(&mut self) -> _TXMUTEW {
        _TXMUTEW { w: self }
    }
    #[doc = "Bit 13 - TXDMAEN"]
    #[inline]
    ...
    #[doc = "Bit 15 - CLKDEN"]
    #[inline]
    pub fn clkden(&mut self) -> _CLKDENW {
        _CLKDENW { w: self }
    }
    #[doc = "Bit 16 - RCEN"]
    #[inline]
    pub fn rcen(&mut self) -> _RCENW {
        _RCENW { w: self }
    }
    #[doc = "Bit 17 - RCSEL"]
    #[inline]
    pub fn rcsel(&mut self) -> _RCSELW {
        _RCSELW { w: self }
    }
    #[doc = "Bit 18 - BCKINV"]
    #[inline]
    pub fn bckinv(&mut self) -> _BCKINVW {
        _BCKINVW { w: self }
    }
    #[doc = "Bit 19 - MCKINV"]
    #[inline]
    pub fn mckinv(&mut self) -> _MCKINVW {
        _MCKINVW { w: self }
    }
}
