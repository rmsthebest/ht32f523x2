...
impl W {
    ...
    #[doc = "Bit 0 - UEVDIS"]
    #[inline]
    pub fn uevdis(&mut self) -> _UEVDISW {
        _UEVDISW { w: self }
    }
    #[doc = "Bit 1 - UGDIS"]
    #[inline]
    pub fn ugdis(&mut self) -> _UGDISW {
        _UGDISW { w: self }
    }
    #[doc = "Bits 8:9 - CKDIV"]
    #[inline]
