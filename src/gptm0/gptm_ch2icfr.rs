#[doc = "Reader of register GPTM_CH2ICFR"]
pub type R = crate::R<u32, super::GPTM_CH2ICFR>;
#[doc = "Writer for register GPTM_CH2ICFR"]
pub type W = crate::W<u32, super::GPTM_CH2ICFR>;
#[doc = "Register GPTM_CH2ICFR `reset()`'s with value 0"]
impl crate::ResetValue for super::GPTM_CH2ICFR {
    type Type = u32;
    #[inline(always)]
