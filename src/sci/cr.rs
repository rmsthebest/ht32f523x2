...
impl W {
    ...
    #[doc = "Bit 0 - CONV"]
    #[inline]
    pub fn conv(&mut self) -> _CONVW {
        _CONVW { w: self }
    }
    #[doc = "Bit 1 - CREP"]
    #[inline]
    pub fn crep(&mut self) -> _CREPW {
        _CREPW { w: self }
    }
    #[doc = "Bit 2 - WTEN"]
    #[inline]
    pub fn wten(&mut self) -> _WTENW {
        _WTENW { w: self }
    }
    #[doc = "Bit 3 - SCIM"]
    #[inline]
    pub fn scim(&mut self) -> _SCIMW {
        _SCIMW { w: self }
    }
    #[doc = "Bit 4 - RETRY"]
    #[inline]
    pub fn retry(&mut self) -> _RETRYW {
        _RETRYW { w: self }
    }
    #[doc = "Bit 5 - ENSCI"]
    #[inline]
    pub fn ensci(&mut self) -> _ENSCIW {
        _ENSCIW { w: self }
    }
    #[doc = "Bit 6 - DETCNF"]
    #[inline]
    pub fn detcnf(&mut self) -> _DETCNFW {
        _DETCNFW { w: self }
    }
    #[doc = "Bit 8 - TXDMA"]
    #[inline]
