...
impl W {
    ...
    #[doc = "Bit 1 - RXCE"]
    #[inline]
    pub fn rxce(&mut self) -> _RXCEW {
        _RXCEW { w: self }
    }
    #[doc = "Bit 2 - TXCE"]
    #[inline]
    pub fn txce(&mut self) -> _TXCEW {
        _TXCEW { w: self }
    }
    #[doc = "Bit 3 - WTE"]
    #[inline]
    ...
    #[doc = "Bit 6 - CARDIRE"]
    #[inline]
    pub fn cardire(&mut self) -> _CARDIREW {
        _CARDIREW { w: self }
    }
    #[doc = "Bit 7 - TXBEE"]
    #[inline]
    pub fn txbee(&mut self) -> _TXBEEW {
        _TXBEEW { w: self }
    }
}
