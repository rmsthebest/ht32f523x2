...
impl W {
    ...
    #[doc = "Bit 4 - DSTAINC"]
    #[inline]
    pub fn dstainc(&mut self) -> _DSTAINCW {
        _DSTAINCW { w: self }
    }
    #[doc = "Bit 5 - DSTAMOD"]
    #[inline]
    pub fn dstamod(&mut self) -> _DSTAMODW {
        _DSTAMODW { w: self }
    }
    #[doc = "Bit 6 - SRCAINC"]
    #[inline]
    pub fn srcainc(&mut self) -> _SRCAINCW {
        _SRCAINCW { w: self }
    }
    #[doc = "Bit 7 - SRCAMOD"]
    #[inline]
    pub fn srcamod(&mut self) -> _SRCAMODW {
        _SRCAMODW { w: self }
    }
    #[doc = "Bits 8:9 - CHPRI"]
    #[inline]
    ...
    #[doc = "Bit 10 - FIXAEN"]
    #[inline]
    pub fn fixaen(&mut self) -> _FIXAENW {
        _FIXAENW { w: self }
    }
    #[doc = "Bit 11 - AUTORL"]
    #[inline]
    pub fn autorl(&mut self) -> _AUTORLW {
        _AUTORLW { w: self }
    }
}
