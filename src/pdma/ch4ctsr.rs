#[doc = "Reader of register CH4CTSR"]
pub type R = crate::R<u32, super::CH4CTSR>;
#[doc = "Writer for register CH4CTSR"]
pub type W = crate::W<u32, super::CH4CTSR>;
#[doc = "Register CH4CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH4CTSR {
    type Type = u32;
    #[inline(always)]
