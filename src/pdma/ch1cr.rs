#[doc = "Reader of register CH1CR"]
pub type R = crate::R<u32, super::CH1CR>;
#[doc = "Writer for register CH1CR"]
pub type W = crate::W<u32, super::CH1CR>;
#[doc = "Register CH1CR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1CR {
    type Type = u32;
    #[inline(always)]
