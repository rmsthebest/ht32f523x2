#[doc = "Reader of register CH5CR"]
pub type R = crate::R<u32, super::CH5CR>;
#[doc = "Writer for register CH5CR"]
pub type W = crate::W<u32, super::CH5CR>;
#[doc = "Register CH5CR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH5CR {
    type Type = u32;
    #[inline(always)]
