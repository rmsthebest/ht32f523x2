...
pub type CBLKLEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH2CTSR_SPEC, u16, u16, 16, O>;
#[doc = "Field `CBLKCNT` reader - CBLKCNT"]
pub type CBLKCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CBLKCNT` writer - CBLKCNT"]
pub type CBLKCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CH2CTSR_SPEC, u16, u16, 16, O>;
impl R {
