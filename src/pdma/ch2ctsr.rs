#[doc = "Reader of register CH2CTSR"]
pub type R = crate::R<u32, super::CH2CTSR>;
#[doc = "Writer for register CH2CTSR"]
pub type W = crate::W<u32, super::CH2CTSR>;
#[doc = "Register CH2CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2CTSR {
    type Type = u32;
    #[inline(always)]
