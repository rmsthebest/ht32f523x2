#[doc = "Reader of register CH1CTSR"]
pub type R = crate::R<u32, super::CH1CTSR>;
#[doc = "Writer for register CH1CTSR"]
pub type W = crate::W<u32, super::CH1CTSR>;
#[doc = "Register CH1CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1CTSR {
    type Type = u32;
    #[inline(always)]
