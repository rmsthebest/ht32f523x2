#[doc = "Reader of register CH0CR"]
pub type R = crate::R<u32, super::CH0CR>;
#[doc = "Writer for register CH0CR"]
pub type W = crate::W<u32, super::CH0CR>;
#[doc = "Register CH0CR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH0CR {
    type Type = u32;
    #[inline(always)]
