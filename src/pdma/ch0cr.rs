...
pub type R = crate::R<Ch0crSpec>;
#[doc = "Register `CH0CR` writer"]
pub type W = crate::W<Ch0crSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn chen(&mut self) -> ChenW<Ch0crSpec> {
        ChenW::new(self, 0)
    }
    #[doc = "Bit 1 - SWTRIG"]
    #[inline(always)]
    #[must_use]
    pub fn swtrig(&mut self) -> SwtrigW<Ch0crSpec> {
        SwtrigW::new(self, 1)
    }
    #[doc = "Bits 2:3 - DWIDTH"]
    #[inline(always)]
    #[must_use]
    pub fn dwidth(&mut self) -> DwidthW<Ch0crSpec> {
        DwidthW::new(self, 2)
    }
    #[doc = "Bit 4 - DSTAINC"]
    #[inline(always)]
    #[must_use]
    pub fn dstainc(&mut self) -> DstaincW<Ch0crSpec> {
        DstaincW::new(self, 4)
    }
    #[doc = "Bit 5 - DSTAMOD"]
    #[inline(always)]
    #[must_use]
    pub fn dstamod(&mut self) -> DstamodW<Ch0crSpec> {
        DstamodW::new(self, 5)
    }
    #[doc = "Bit 6 - SRCAINC"]
    #[inline(always)]
    #[must_use]
    pub fn srcainc(&mut self) -> SrcaincW<Ch0crSpec> {
        SrcaincW::new(self, 6)
    }
    #[doc = "Bit 7 - SRCAMOD"]
    #[inline(always)]
    #[must_use]
    pub fn srcamod(&mut self) -> SrcamodW<Ch0crSpec> {
        SrcamodW::new(self, 7)
    }
    #[doc = "Bits 8:9 - CHPRI"]
    #[inline(always)]
    #[must_use]
    pub fn chpri(&mut self) -> ChpriW<Ch0crSpec> {
        ChpriW::new(self, 8)
    }
    #[doc = "Bit 10 - FIXAEN"]
    #[inline(always)]
    #[must_use]
    pub fn fixaen(&mut self) -> FixaenW<Ch0crSpec> {
        FixaenW::new(self, 10)
    }
    #[doc = "Bit 11 - AUTORL"]
    #[inline(always)]
    #[must_use]
    pub fn autorl(&mut self) -> AutorlW<Ch0crSpec> {
        AutorlW::new(self, 11)
    }
}
#[doc = "CH0CR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ch0cr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ch0cr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ch0crSpec;
impl crate::RegisterSpec for Ch0crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch0cr::R`](R) reader structure"]
impl crate::Readable for Ch0crSpec {}
#[doc = "`write(|w| ..)` method takes [`ch0cr::W`](W) writer structure"]
impl crate::Writable for Ch0crSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH0CR to value 0"]
impl crate::Resettable for Ch0crSpec {
