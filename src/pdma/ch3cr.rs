#[doc = "Reader of register CH3CR"]
pub type R = crate::R<u32, super::CH3CR>;
#[doc = "Writer for register CH3CR"]
pub type W = crate::W<u32, super::CH3CR>;
#[doc = "Register CH3CR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3CR {
    type Type = u32;
    #[inline(always)]
