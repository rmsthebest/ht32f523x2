#[doc = "Reader of register CH3TSR"]
pub type R = crate::R<u32, super::CH3TSR>;
#[doc = "Writer for register CH3TSR"]
pub type W = crate::W<u32, super::CH3TSR>;
#[doc = "Register CH3TSR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3TSR {
    type Type = u32;
    #[inline(always)]
