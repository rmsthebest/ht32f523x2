#[doc = "Reader of register CH2CR"]
pub type R = crate::R<u32, super::CH2CR>;
#[doc = "Writer for register CH2CR"]
pub type W = crate::W<u32, super::CH2CR>;
#[doc = "Register CH2CR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2CR {
    type Type = u32;
    #[inline(always)]
