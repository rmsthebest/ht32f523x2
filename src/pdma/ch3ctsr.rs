#[doc = "Reader of register CH3CTSR"]
pub type R = crate::R<u32, super::CH3CTSR>;
#[doc = "Writer for register CH3CTSR"]
pub type W = crate::W<u32, super::CH3CTSR>;
#[doc = "Register CH3CTSR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH3CTSR {
    type Type = u32;
    #[inline(always)]
