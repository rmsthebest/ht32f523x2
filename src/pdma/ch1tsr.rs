#[doc = "Reader of register CH1TSR"]
pub type R = crate::R<u32, super::CH1TSR>;
#[doc = "Writer for register CH1TSR"]
pub type W = crate::W<u32, super::CH1TSR>;
#[doc = "Register CH1TSR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1TSR {
    type Type = u32;
    #[inline(always)]
