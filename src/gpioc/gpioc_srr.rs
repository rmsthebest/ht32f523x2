...
impl W {
    ...
    #[doc = "Bit 16 - RST0"]
    #[inline]
    pub fn rst0(&mut self) -> _RST0W {
        _RST0W { w: self }
    }
    #[doc = "Bit 17 - RST1"]
    #[inline]
    pub fn rst1(&mut self) -> _RST1W {
        _RST1W { w: self }
    }
    #[doc = "Bit 18 - RST2"]
    #[inline]
    pub fn rst2(&mut self) -> _RST2W {
        _RST2W { w: self }
    }
    #[doc = "Bit 19 - RST3"]
    #[inline]
    pub fn rst3(&mut self) -> _RST3W {
        _RST3W { w: self }
    }
    #[doc = "Bit 20 - RST4"]
    #[inline]
    pub fn rst4(&mut self) -> _RST4W {
        _RST4W { w: self }
    }
    #[doc = "Bit 21 - RST5"]
    #[inline]
    pub fn rst5(&mut self) -> _RST5W {
        _RST5W { w: self }
    }
    #[doc = "Bit 22 - RST6"]
    #[inline]
    pub fn rst6(&mut self) -> _RST6W {
        _RST6W { w: self }
    }
    #[doc = "Bit 23 - RST7"]
    #[inline]
    pub fn rst7(&mut self) -> _RST7W {
        _RST7W { w: self }
    }
    #[doc = "Bit 24 - RST8"]
    #[inline]
    pub fn rst8(&mut self) -> _RST8W {
        _RST8W { w: self }
    }
    #[doc = "Bit 25 - RST9"]
    #[inline]
    pub fn rst9(&mut self) -> _RST9W {
        _RST9W { w: self }
    }
    #[doc = "Bit 26 - RST10"]
    #[inline]
    pub fn rst10(&mut self) -> _RST10W {
        _RST10W { w: self }
    }
    #[doc = "Bit 27 - RST11"]
    #[inline]
    pub fn rst11(&mut self) -> _RST11W {
        _RST11W { w: self }
    }
    #[doc = "Bit 28 - RST12"]
    #[inline]
    pub fn rst12(&mut self) -> _RST12W {
        _RST12W { w: self }
    }
    #[doc = "Bit 29 - RST13"]
    #[inline]
    pub fn rst13(&mut self) -> _RST13W {
        _RST13W { w: self }
    }
    #[doc = "Bit 30 - RST14"]
    #[inline]
    pub fn rst14(&mut self) -> _RST14W {
        _RST14W { w: self }
    }
    #[doc = "Bit 31 - RST15"]
    #[inline]
    pub fn rst15(&mut self) -> _RST15W {
        _RST15W { w: self }
    }
}
