...
impl W {
    ...
    #[doc = "Bit 6 - EBIRST"]
    #[inline]
    pub fn ebirst(&mut self) -> _EBIRSTW {
        _EBIRSTW { w: self }
    }
    #[doc = "Bit 7 - CRCRST"]
    #[inline]
    ...
    #[doc = "Bit 8 - PARST"]
    #[inline]
    pub fn parst(&mut self) -> _PARSTW {
        _PARSTW { w: self }
    }
    #[doc = "Bit 9 - PBRST"]
    #[inline]
    pub fn pbrst(&mut self) -> _PBRSTW {
        _PBRSTW { w: self }
    }
    #[doc = "Bit 10 - PCRST"]
    #[inline]
    pub fn pcrst(&mut self) -> _PCRSTW {
        _PCRSTW { w: self }
    }
    #[doc = "Bit 11 - PDRST"]
    #[inline]
    pub fn pdrst(&mut self) -> _PDRSTW {
        _PDRSTW { w: self }
    }
}
