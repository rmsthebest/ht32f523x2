...
impl W {
    ...
    #[doc = "Bit 2 - ADRS"]
    #[inline]
    pub fn adrs(&mut self) -> _ADRSW {
        _ADRSW { w: self }
    }
    #[doc = "Bit 3 - GCS"]
    #[inline]
    pub fn gcs(&mut self) -> _GCSW {
        _GCSW { w: self }
    }
    #[doc = "Bit 8 - ARBLOS"]
    #[inline]
    pub fn arblos(&mut self) -> _ARBLOSW {
        _ARBLOSW { w: self }
    }
    #[doc = "Bit 9 - RXNACK"]
    #[inline]
    ...
    #[doc = "Bit 11 - TOUTF"]
    #[inline]
    pub fn toutf(&mut self) -> _TOUTFW {
        _TOUTFW { w: self }
    }
    #[doc = "Bit 16 - RXDNE"]
    #[inline]
    pub fn rxdne(&mut self) -> _RXDNEW {
        _RXDNEW { w: self }
    }
    #[doc = "Bit 17 - TXDE"]
    #[inline]
    pub fn txde(&mut self) -> _TXDEW {
        _TXDEW { w: self }
    }
    #[doc = "Bit 18 - RXBF"]
    #[inline]
    pub fn rxbf(&mut self) -> _RXBFW {
        _RXBFW { w: self }
    }
    #[doc = "Bit 19 - BUSBUSY"]
    #[inline]
    pub fn busbusy(&mut self) -> _BUSBUSYW {
        _BUSBUSYW { w: self }
    }
    #[doc = "Bit 20 - MASTER"]
    #[inline]
