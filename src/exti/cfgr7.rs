#[doc = "Reader of register CFGR7"]
pub type R = crate::R<u32, super::CFGR7>;
#[doc = "Writer for register CFGR7"]
pub type W = crate::W<u32, super::CFGR7>;
#[doc = "Register CFGR7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CFGR7 {
    type Type = u32;
    #[inline(always)]
