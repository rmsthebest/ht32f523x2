#[doc = "Reader of register CFGR6"]
pub type R = crate::R<u32, super::CFGR6>;
#[doc = "Writer for register CFGR6"]
pub type W = crate::W<u32, super::CFGR6>;
#[doc = "Register CFGR6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CFGR6 {
    type Type = u32;
    #[inline(always)]
