#[doc = "Reader of register CFGR5"]
pub type R = crate::R<u32, super::CFGR5>;
#[doc = "Writer for register CFGR5"]
pub type W = crate::W<u32, super::CFGR5>;
#[doc = "Register CFGR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CFGR5 {
    type Type = u32;
    #[inline(always)]
