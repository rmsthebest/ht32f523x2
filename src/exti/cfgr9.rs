...
pub type R = crate::R<Cfgr9Spec>;
#[doc = "Register `CFGR9` writer"]
pub type W = crate::W<Cfgr9Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbcnt(&mut self) -> DbcntW<Cfgr9Spec> {
        DbcntW::new(self, 0)
    }
    #[doc = "Bits 28:30 - SRCTYPE"]
    #[inline(always)]
    #[must_use]
    pub fn srctype(&mut self) -> SrctypeW<Cfgr9Spec> {
        SrctypeW::new(self, 28)
    }
    #[doc = "Bit 31 - DBEN"]
    #[inline(always)]
    #[must_use]
    pub fn dben(&mut self) -> DbenW<Cfgr9Spec> {
        DbenW::new(self, 31)
    }
}
...
pub struct Cfgr9Spec;
impl crate::RegisterSpec for Cfgr9Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cfgr9::R`](R) reader structure"]
impl crate::Readable for Cfgr9Spec {}
#[doc = "`write(|w| ..)` method takes [`cfgr9::W`](W) writer structure"]
impl crate::Writable for Cfgr9Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CFGR9 to value 0"]
impl crate::Resettable for Cfgr9Spec {
