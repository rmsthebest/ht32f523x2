#[doc = "Reader of register CFGR8"]
pub type R = crate::R<u32, super::CFGR8>;
#[doc = "Writer for register CFGR8"]
pub type W = crate::W<u32, super::CFGR8>;
#[doc = "Register CFGR8 `reset()`'s with value 0"]
impl crate::ResetValue for super::CFGR8 {
    type Type = u32;
    #[inline(always)]
