...
pub type DBCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR0_SPEC, u16, u16, 16, O>;
#[doc = "Field `SRCTYPE` reader - SRCTYPE"]
pub type SRCTYPE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SRCTYPE` writer - SRCTYPE"]
pub type SRCTYPE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CFGR0_SPEC, u8, u8, 3, O>;
#[doc = "Field `DBEN` reader - DBEN"]
pub type DBEN_R = crate::BitReader<bool>;
#[doc = "Field `DBEN` writer - DBEN"]
pub type DBEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFGR0_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:15 - DBCNT"]
    #[inline(always)]
