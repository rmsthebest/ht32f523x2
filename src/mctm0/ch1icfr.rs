#[doc = "Reader of register CH1ICFR"]
pub type R = crate::R<u32, super::CH1ICFR>;
#[doc = "Writer for register CH1ICFR"]
pub type W = crate::W<u32, super::CH1ICFR>;
#[doc = "Register CH1ICFR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH1ICFR {
    type Type = u32;
    #[inline(always)]
