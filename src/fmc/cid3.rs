...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cid(&mut self) -> CidW<Cid3Spec> {
        CidW::new(self, 0)
    }
}
#[doc = "CID3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cid3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`cid3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cid3Spec;
...
impl crate::Writable for Cid3Spec {
