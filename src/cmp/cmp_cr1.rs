...
impl W {
    ...
    #[doc = "Bit 1 - CMPSM"]
    #[inline]
    pub fn cmpsm(&mut self) -> _CMPSMW {
        _CMPSMW { w: self }
    }
    #[doc = "Bits 2:3 - CMPHM"]
    #[inline]
    pub fn cmphm(&mut self) -> _CMPHMW {
        _CMPHMW { w: self }
    }
    #[doc = "Bits 4:5 - CMPINSEL"]
    #[inline]
    pub fn cmpinsel(&mut self) -> _CMPINSELW {
        _CMPINSELW { w: self }
    }
    #[doc = "Bit 6 - CMPPOL"]
    #[inline]
    ...
    #[doc = "Bit 7 - SYNCSEL"]
    #[inline]
    pub fn syncsel(&mut self) -> _SYNCSELW {
        _SYNCSELW { w: self }
    }
    #[doc = "Bit 8 - CVREN"]
    #[inline]
    pub fn cvren(&mut self) -> _CVRENW {
        _CVRENW { w: self }
    }
    #[doc = "Bit 9 - CVROE"]
    #[inline]
    pub fn cvroe(&mut self) -> _CVROEW {
        _CVROEW { w: self }
    }
    #[doc = "Bit 10 - CVRSS"]
    #[inline]
    pub fn cvrss(&mut self) -> _CVRSSW {
        _CVRSSW { w: self }
    }
    #[doc = "Bits 11:13 - CMPOSEL"]
    #[inline]
    pub fn cmposel(&mut self) -> _CMPOSELW {
        _CMPOSELW { w: self }
    }
    #[doc = "Bit 14 - CMPWPEN"]
    #[inline]
    pub fn cmpwpen(&mut self) -> _CMPWPENW {
        _CMPWPENW { w: self }
    }
    #[doc = "Bit 15 - CMPSTS"]
    #[inline]
    pub fn cmpsts(&mut self) -> _CMPSTSW {
        _CMPSTSW { w: self }
    }
    #[doc = "Bits 16:31 - PROTECT"]
    #[inline]
