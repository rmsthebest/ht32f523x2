...
pub type TI0F_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPTM_CH0ICFR_SPEC, u8, u8, 4, O>;
#[doc = "Field `CH0CCS` reader - CH0CCS"]
pub type CH0CCS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH0CCS` writer - CH0CCS"]
pub type CH0CCS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPTM_CH0ICFR_SPEC, u8, u8, 2, O>;
#[doc = "Field `CH0PSC` reader - CH0PSC"]
pub type CH0PSC_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH0PSC` writer - CH0PSC"]
pub type CH0PSC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPTM_CH0ICFR_SPEC, u8, u8, 2, O>;
#[doc = "Field `TI0SRC` reader - TI0SRC"]
pub type TI0SRC_R = crate::BitReader<bool>;
#[doc = "Field `TI0SRC` writer - TI0SRC"]
pub type TI0SRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPTM_CH0ICFR_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:3 - TI0F"]
    #[inline(always)]
