...
pub type R = crate::R<GpacfghrSpec>;
#[doc = "Register `GPACFGHR` writer"]
pub type W = crate::W<GpacfghrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cfg8(&mut self) -> Cfg8W<GpacfghrSpec> {
        Cfg8W::new(self, 0)
    }
    #[doc = "Bits 4:7 - CFG9"]
    #[inline(always)]
    #[must_use]
    pub fn cfg9(&mut self) -> Cfg9W<GpacfghrSpec> {
        Cfg9W::new(self, 4)
    }
    #[doc = "Bits 8:11 - CFG10"]
    #[inline(always)]
    #[must_use]
    pub fn cfg10(&mut self) -> Cfg10W<GpacfghrSpec> {
        Cfg10W::new(self, 8)
    }
    #[doc = "Bits 12:15 - CFG11"]
    #[inline(always)]
    #[must_use]
    pub fn cfg11(&mut self) -> Cfg11W<GpacfghrSpec> {
        Cfg11W::new(self, 12)
    }
    #[doc = "Bits 16:19 - CFG12"]
    #[inline(always)]
    #[must_use]
    pub fn cfg12(&mut self) -> Cfg12W<GpacfghrSpec> {
        Cfg12W::new(self, 16)
    }
    #[doc = "Bits 20:23 - CFG13"]
    #[inline(always)]
    #[must_use]
    pub fn cfg13(&mut self) -> Cfg13W<GpacfghrSpec> {
        Cfg13W::new(self, 20)
    }
    #[doc = "Bits 24:27 - CFG14"]
    #[inline(always)]
    #[must_use]
    pub fn cfg14(&mut self) -> Cfg14W<GpacfghrSpec> {
        Cfg14W::new(self, 24)
    }
    #[doc = "Bits 28:31 - CFG15"]
    #[inline(always)]
    #[must_use]
    pub fn cfg15(&mut self) -> Cfg15W<GpacfghrSpec> {
        Cfg15W::new(self, 28)
    }
}
#[doc = "GPACFGHR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpacfghr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpacfghr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpacfghrSpec;
impl crate::RegisterSpec for GpacfghrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpacfghr::R`](R) reader structure"]
impl crate::Readable for GpacfghrSpec {}
#[doc = "`write(|w| ..)` method takes [`gpacfghr::W`](W) writer structure"]
impl crate::Writable for GpacfghrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPACFGHR to value 0"]
impl crate::Resettable for GpacfghrSpec {
