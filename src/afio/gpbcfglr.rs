...
pub type R = crate::R<GpbcfglrSpec>;
#[doc = "Register `GPBCFGLR` writer"]
pub type W = crate::W<GpbcfglrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cfg0(&mut self) -> Cfg0W<GpbcfglrSpec> {
        Cfg0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - CFG1"]
    #[inline(always)]
    #[must_use]
    pub fn cfg1(&mut self) -> Cfg1W<GpbcfglrSpec> {
        Cfg1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - CFG2"]
    #[inline(always)]
    #[must_use]
    pub fn cfg2(&mut self) -> Cfg2W<GpbcfglrSpec> {
        Cfg2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - CFG3"]
    #[inline(always)]
    #[must_use]
    pub fn cfg3(&mut self) -> Cfg3W<GpbcfglrSpec> {
        Cfg3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - CFG4"]
    #[inline(always)]
    #[must_use]
    pub fn cfg4(&mut self) -> Cfg4W<GpbcfglrSpec> {
        Cfg4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - CFG5"]
    #[inline(always)]
    #[must_use]
    pub fn cfg5(&mut self) -> Cfg5W<GpbcfglrSpec> {
        Cfg5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - CFG6"]
    #[inline(always)]
    #[must_use]
    pub fn cfg6(&mut self) -> Cfg6W<GpbcfglrSpec> {
        Cfg6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - CFG7"]
    #[inline(always)]
    #[must_use]
    pub fn cfg7(&mut self) -> Cfg7W<GpbcfglrSpec> {
        Cfg7W::new(self, 28)
    }
}
...
pub struct GpbcfglrSpec;
impl crate::RegisterSpec for GpbcfglrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpbcfglr::R`](R) reader structure"]
impl crate::Readable for GpbcfglrSpec {}
#[doc = "`write(|w| ..)` method takes [`gpbcfglr::W`](W) writer structure"]
impl crate::Writable for GpbcfglrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPBCFGLR to value 0"]
impl crate::Resettable for GpbcfglrSpec {
