...
pub type R = crate::R<GpccfglrSpec>;
#[doc = "Register `GPCCFGLR` writer"]
pub type W = crate::W<GpccfglrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cfg0(&mut self) -> Cfg0W<GpccfglrSpec> {
        Cfg0W::new(self, 0)
    }
    #[doc = "Bits 4:7 - CFG1"]
    #[inline(always)]
    #[must_use]
    pub fn cfg1(&mut self) -> Cfg1W<GpccfglrSpec> {
        Cfg1W::new(self, 4)
    }
    #[doc = "Bits 8:11 - CFG2"]
    #[inline(always)]
    #[must_use]
    pub fn cfg2(&mut self) -> Cfg2W<GpccfglrSpec> {
        Cfg2W::new(self, 8)
    }
    #[doc = "Bits 12:15 - CFG3"]
    #[inline(always)]
    #[must_use]
    pub fn cfg3(&mut self) -> Cfg3W<GpccfglrSpec> {
        Cfg3W::new(self, 12)
    }
    #[doc = "Bits 16:19 - CFG4"]
    #[inline(always)]
    #[must_use]
    pub fn cfg4(&mut self) -> Cfg4W<GpccfglrSpec> {
        Cfg4W::new(self, 16)
    }
    #[doc = "Bits 20:23 - CFG5"]
    #[inline(always)]
    #[must_use]
    pub fn cfg5(&mut self) -> Cfg5W<GpccfglrSpec> {
        Cfg5W::new(self, 20)
    }
    #[doc = "Bits 24:27 - CFG6"]
    #[inline(always)]
    #[must_use]
    pub fn cfg6(&mut self) -> Cfg6W<GpccfglrSpec> {
        Cfg6W::new(self, 24)
    }
    #[doc = "Bits 28:31 - CFG7"]
    #[inline(always)]
    #[must_use]
    pub fn cfg7(&mut self) -> Cfg7W<GpccfglrSpec> {
        Cfg7W::new(self, 28)
    }
}
#[doc = "GPCCFGLR\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpccfglr::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpccfglr::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GpccfglrSpec;
impl crate::RegisterSpec for GpccfglrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gpccfglr::R`](R) reader structure"]
impl crate::Readable for GpccfglrSpec {}
#[doc = "`write(|w| ..)` method takes [`gpccfglr::W`](W) writer structure"]
impl crate::Writable for GpccfglrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GPCCFGLR to value 0"]
impl crate::Resettable for GpccfglrSpec {
